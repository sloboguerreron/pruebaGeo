 ...
 */
import './L.Control.Layers.Tree.css'
...
(function(L) {
    ...
    L.Control.Layers.Tree = L.Control.Layers.extend({
        ...
        _iterateTreeLayout: function(tree, container, overlay, selAllNodes, noShow) {
            ...
            var closed = creator('div', this.cls.closed, sel, this.options.closedSymbol);
            var opened = creator('div', this.cls.opened, sel, this.options.openedSymbol);
